...
type PageInfo struct {
	...
	PSize uint32 `protobuf:"varint,2,opt,name=pSize,proto3" json:"pSize,omitempty"` // 每页数量
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x30, 0x0a, 0x08, 0x50, 0x61, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e,
	...
	0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x72, 0x6f, 0x6c, 0x65, 0x22, 0x57, 0x0a, 0x10, 0x55,
	...
	0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73,
	...
	0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0x8d,
	0x03, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x3b, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x42,
	...
	0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3c, 0x0a, 0x0b, 0x47, 0x65,
	...
	0x19, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e,
	0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3d, 0x0a, 0x0a, 0x55, 0x70,
	...
	0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x12, 0x43, 0x0a, 0x0d, 0x43, 0x68, 0x65,
	0x63, 0x6b, 0x50, 0x61, 0x73, 0x73, 0x57, 0x6f, 0x72, 0x64, 0x12, 0x1a, 0x2e, 0x75, 0x73, 0x65,
	...
	0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x20,
	0x5a, 0x1e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x67, 0x2f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65,
	0x73, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x3b, 0x76, 0x31,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*MobileRequest)(nil),     // 1: user.v1.MobileRequest
	(*IdRequest)(nil),         // 2: user.v1.IdRequest
	(*CreateUserInfo)(nil),    // 3: user.v1.CreateUserInfo
	(*UpdateUserInfo)(nil),    // 4: user.v1.UpdateUserInfo
	(*UserInfoResponse)(nil),  // 5: user.v1.UserInfoResponse
	(*UserListResponse)(nil),  // 6: user.v1.UserListResponse
	(*PasswordCheckInfo)(nil), // 7: user.v1.PasswordCheckInfo
	(*CheckResponse)(nil),     // 8: user.v1.CheckResponse
	(*emptypb.Empty)(nil),     // 9: google.protobuf.Empty
}
var file_user_proto_depIdxs = []int32{
	5, // 0: user.v1.UserListResponse.data:type_name -> user.v1.UserInfoResponse
	0, // 1: user.v1.User.GetUserList:input_type -> user.v1.PageInfo
	1, // 2: user.v1.User.GetUserByMobile:input_type -> user.v1.MobileRequest
	2, // 3: user.v1.User.GetUserById:input_type -> user.v1.IdRequest
	3, // 4: user.v1.User.CreateUser:input_type -> user.v1.CreateUserInfo
	4, // 5: user.v1.User.UpdateUser:input_type -> user.v1.UpdateUserInfo
	7, // 6: user.v1.User.CheckPassWord:input_type -> user.v1.PasswordCheckInfo
	6, // 7: user.v1.User.GetUserList:output_type -> user.v1.UserListResponse
	5, // 8: user.v1.User.GetUserByMobile:output_type -> user.v1.UserInfoResponse
	5, // 9: user.v1.User.GetUserById:output_type -> user.v1.UserInfoResponse
	5, // 10: user.v1.User.CreateUser:output_type -> user.v1.UserInfoResponse
